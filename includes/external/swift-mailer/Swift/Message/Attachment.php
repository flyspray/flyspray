...
class Swift_Message_Attachment extends Swift_Message_Mime
{
	...
	{
		if ($this->headers->hasAttribute("Content-Disposition", "filename"))
		{
			return $this->headers->getAttribute("Content-Disposition", "filename");
		}
		else return null;
	}
	/**
	...
	function preBuild()
	{
		if ($this->getFileName() === null)
		{
			...
			else
			{
				...
				$this->setFileName($maker->Generate("file.att."));
			}
		}
	}
}
