...
class Setup extends Flyspray
{
    ...
    public function ProcessAdminConfig($data)
    {
      ...
      ; a web browser, and editing header.php to point to wherever you put this file.\n";
        ...
        $config[] = "[webservices]";
        $config[] = "allow_web_services = 1                                 ;allows access to the webservices rest engine.";
        $config[] = "application_api_key = ".$this->GUID()."             ;uniquely identifies this instance of flyspray.";
        $config[] = "web_services_username_salt = ".$this->GUID()."          ;Random String for salting the user name.";
        $config[] = "web_services_password_salt = ".$this->GUID()."         ;Randon string for salting the users password.";
