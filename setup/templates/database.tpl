      <div id="right">
         ...
         <div class="installBlock">
            ...
            <tr>
               ...
               <td><?php echo Filters::noXSS(L('databasehostnamehint')); ?></td>
            </tr>
            <tr>
               ...
               <td><?php echo Filters::noXSS(L('databasetypehint')); ?></td>
            </tr>
            <tr>
               ...
               <td><?php echo Filters::noXSS(L('databasenamehint')); ?></td>
            </tr>
            <tr>
               ...
               <td rowspan="2"><?php echo Filters::noXSS(L('databaseusernamehint')); ?></td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td><?php echo Filters::noXSS(L('tableprefixhint')); ?></td>
            </tr>
            </table>
         </div>
         <div class="clr"></div>
