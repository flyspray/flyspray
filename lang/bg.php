...
'listnote'                => 'Забележка: Изключването на "Показване" може да измени някои задачи в режим на редактиране. Промяната на полето "Име" ще смени всички задачи с това име.',
'name'                    => 'Име',
'order'                   => 'Ред',
'back'                    => 'Назад',
'text'                    => 'Текст',
