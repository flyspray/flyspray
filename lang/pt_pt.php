<?php
/**
*  Adaptado do pt_br para pt_pt por André Nunes - andre.garcia.nunes@gmail.com
...
'taskblocks'              => 'Esta tarefa bloqueia estas de fechar',
...
'confirmdeletecomment'    => 'Quer mesmo apagar este comentário?  Todos os anexos também serão apagados!',
...
'youonnotify'             => 'Está recebendo isto porque você está na lista da notificação.',
...
'filename'                => 'Ficheiro:',
'fileuploaded'            => 'Ficheiro foi enviado.',
...
'addressused'             => 'Este endereço foi usado para registo numa conta no Flyspray.  Se você não esperava esta mensagem, por favor ignore e apague.  Vá para o seguinte endereço para completar seu registo:',
...
'registernewuser'         => 'Registrar novo utilizador',
'none'                    => 'Nenhum',
'registeraccount'         => 'Registrar esta conta',
'both'                    => 'Ambos',
'notifyfrom'              => 'Notificação de ',
'donotreply'              => 'ESTA é UMA MENSAGEM AUTOMáTICA, NãO RESPONDA.',
'disclaimer'              => 'Está recebendo esta mensagem porque você requisitou do Sistema de Bugtracking Flyspray.  Se você não esperava esta mensagem ou não quer receber e-mails no futuro, você pode alterar suas definições de notificação no URL abaixo.',
...
'note'                    => '<strong>Nota:</strong>  Você receberá um código de confirmação antes da criação da sua conta. O código será enviado através do seu método de notificação especificado acima. <br />Se você fornecer dados falso, <strong>não receberá o seu código</strong>.',
...
'ssl'                     => 'SSL',
'updatewrong'             => 'Você tem a verificação de atualizações habilitada, mas um erro ocorreu ao tentar 
...
'error12'                 => 'Sem chave mágica! Você está certo de que a recebeu na mensagem de notificação?',
