...
'themestyle'              => 'Stil',
'language'                => 'Språk',
'anonview'                => 'Tillate anonyme brukere Ã¥ vise oppgaver',
'allowanon'               => 'Tillat anonyme brukere til Ã¥ Ã¥pne nye oppgaver',
'never'                   => 'Aldri',
'anonymously'             => 'Anonymt',
...
'forcenotify'             => 'Force oppgave varslinger som',
...
'othersview'              => 'Tillat alle Ã¥ se dette prosjektet',
...
'applymember'             => 'SÃ¸k om Prosjekt medlemskap',
'forcurrentproj'          => 'For aktuelt prosjekt',
'lostpw'                  => 'Mistet passord gjen oppreting',
'lostpwexplain'           => "Skriv inn ditt brukernavn, for Ã¥ sende en link for Ã¥ endre passordet ditt. Dette vil bli sendt til varsling adresse i profilen din.\n",
'sendlink'                => 'Send lenke',
...
'editglobalgroup'         => 'Edit Global Grupper',
'editgroupforproj'        => 'Rediger gruppe for Prosjekt',
'notshownforadmin'        => "Tillatelser er ikke vist for admin-gruppen. Du trenger ikke Ã¥ redigere dem.\n",
'general'                 => 'Generelt',
...
'usereminderdaemon'       => 'Aktiver bakgrunns pÃ¥minnelse daemon',
'tasksperpage'            => 'Oppgaver pr. side på oppgavelisten',
'addtoassignees'          => 'Legg selv til fÃ¸lgere',
...
'waitwhiletransfer'       => 'Vennligst vent mens du blir overfÃ¸rt ...',
'clicknowait'             => 'Klikk her hvis du ikke Ã¸nsker Ã¥ vente.',
...
'defaultdueinversion'     => 'Standard utlÃ¸p i versjon for nye oppgaver',
'undecided'               => 'Ubestemt',
...
'receivenotify'           => "Disse brukerne vil motta detaljvarsler nÃ¥r denne oppgaven endres.\n",
...
'theseusersnotify'        => "Disse brukerne vil motta detaljerte varsler nÃ¥r denne oppgaven endres.\n",
'attachedtoproject'       => 'Tiknyttet applikasjon',
'reminders'               => 'Påminnelser',
'system'                  => 'System',
'remindthisuser'          => 'Påminn denne brukeren',
'thisoften'               => 'sÃ¥ ofte',
'startafter'              => 'Vent fÃ¸r du starter pÃ¥minnelser',
'hour'                    => 'time',
'hours'                   => 'timer',
'day'                     => 'dag',
'days'                    => 'dager',
...
'deletedasrelated'        => 'Task fjernet fra den aktuelle listen',
...
'reopenrequestmade'       => 'Bedt om oppgaven som skal gjenÃ¥pnes',
...
'showdetailserror'        => 'At oppgaven ikke finnes, eller du har ikke tillatelse til Ã¥ vise det.',
'makeprivate'             => 'Gjør personlig',
'makepublic'              => 'offentliggjÃ¸re',
...
'attachementswilldeleted' => 'Alle vedlegg vil ogsÃ¥ bli slettet!',
'confirmdeleteattach'     => 'Er du sikker pÃ¥ at du vil slette dette vedlegget?',
'selectedhistory'         => 'Viser valgte historie detaljer',
'showallhistory'          => 'Vis full historikk tab igjen',
'hidethis'                => 'Skjule dette omrÃ¥det igjen',
'mark100'                 => 'Marker oppgave som 100% fullført',
'watchtask'               => 'overvÃ¥k oppgave',
'stopwatching'            => 'Stopp overvåking',
'commentlink'             => 'Lenke til denne kommentaren',
'submitreq'               => 'Send forespÃ¸rsel',
'reasonforreq'            => 'Ã…rsak til forespÃ¸rsel',
'pmreqdenied'             => 'Prosjektleder nektet forespÃ¸rsel',
...
'duedate'                 => 'Frist',
'attachnoperms'           => "Det er vedlegg med denne kommentarer, men du har ingen tillatelse til Ã¥ vise dem.\n",
'linknoperms'             => "Det er linker med denne kommentarer, men du har ingen tillatelse til Ã¥ vise dem.\n",
'open'                    => 'Åpen',
...
'notyetassigned'          => 'EnnÃ¥ ikke tildelt',
...
'currentversion'          => 'Din nÃ¥vÃ¦rende versjon er',
'latestversion'           => 'og den siste versjonen er',
'hidemessage'             => '(Minn meg pÃ¥ det senere)',
...
'lostpwmsg1'              => "Hei\n\nJeg har mistet passordet mitt for flyspray pÃ¥ _\n",
'lostpwmsg2'              => "Vennligst gi meg med et nytt passord.\n\nBrukernavn: _",
'regards'                 => "\n\nHilsen,",
'yourusername'            => '_ ditt brukernavn _',
'locale'                  => 'en-US',
'filenotexist'            => "Filen ikke finnes, eller du har ikke tillatelse til Ã¥ fÃ¥ tilgang til det.\n",
...
'errorpage'               => "Flyspray kan ikke gi den siden du ba om.\nKanskje du har bedt om en oppgave som ikke finnes, eller du\nhar ikke tillatelse til Ã¥ vise den siden du Ã¸nsket. <br /> <br />\nDu har kanskje prÃ¸vd Ã¥ bruke en slem URL til Ã¥ samhandle med databasen\nbackend bruker SQL-injeksjon. Hvis dette er sant, kan du gÃ¥ til hjÃ¸rnet og tror\nom dine handlinger. NÃ¥r du kommer tilbake, mÃ¥ du ikke gjÃ¸re det igjen!",
'permissionsforproject'   => 'Tillatelser for ',
'switchto'                => 'Bytte til',
'lastsearch'              => 'Siste sÃ¸k',
'modify'                  => 'Endre',
'noticefrom'              => 'Varsel fra',
'hasopened'               => 'har Ã¥pnet en ny flyspray oppgave, og tildelt den til deg:',
'moreinfonew'             => 'Du kan finne mer informasjon om denne feilen pÃ¥ flyspray side:',
'newtaskcategory'         => 'En ny flyspray oppgave har blitt Ã¥pnet i denne kategorien',
'categoryowner'           => 'Du mottar dette fordi du er oppfÃ¸rt som kategori eieren.',
'tasksummary'             => 'Oppgavesammendrag:',
'newtaskadded'            => 'Din nye oppgaven er lagt til.',
'summaryanddetails'       => 'Du mÃ¥ fylle inn bÃ¥de sammendraget og detaljene.',
'goback'                  => 'GÃ¥ tilbake.',
'messagefrom'             => 'Dette er en melding fra flyspray bug tracking system pÃ¥ _',
'hasjustmodified'         => 'har nettopp endret fÃ¸lgende oppgave.',
'changedfields'           => 'Endrede felt er prefikset med stjerner (**)',
'moreinfomodify'          => "Du kan fÃ¥ mer informasjon om denne oppgaven pÃ¥ fÃ¸lgende nettadresse:\n",
'nolongerassigned'        => "FÃ¸lgende oppgave er ikke lenger tildelt deg. Det er nÃ¥ tildelt\n",
'hasassigned'             => 'har tildelt deg fÃ¸lgende flyspray oppgave:',
'taskupdated'             => 'Oppgaven er oppdatert',
'tasksupdated'            => 'Oppgaver har blitt oppdatert.',
'hasclosedassigned'       => "har stengt fÃ¸lgende flyspray oppgaven du ble tildelt:\n",
'unassigned'              => 'Ikke tildelt',
'hasclosed'               => 'har stengt følgende oppgave.',
'youonnotify'             => "Du mottar dette fordi du er pÃ¥ varslingslisten.\n",
...
'noclosereason'           => 'Du har ikke valgt en grunn for Ã¥ stenge denne oppgaven.',
'hasreopened'             => 'har gjenÃ¥pnet fÃ¸lgende Flyspray oppgave som du lukket:',
...
'commenttoassigned'       => 'har lagt til en kommentar til en oppgave du har fÃ¥tt tildelt:',
'commenttotask'           => 'har lagt fÃ¸lgende kommentar til denne oppgaven.',
'nocommententered'        => "Du bÃ¸r legge inn en kommentar fÃ¸r du klikker pÃ¥ send-knappen.\n",
...
'usernametaken'           => "Dette brukernavnet er allerede i bruk. Du mÃ¥ velge en annen.\n",
...
'newuserwarning'          => "Legg merke til at de globale preferanser kan kreve kontoen din for Ã¥ bli godkjent av en administrator. Hvis du ikke kan logge inn, dette er nok derfor.\n",
...
'hasattached'             => 'har festet en fil til fÃ¸lgende oppgave.',
'fileuploaded'            => 'Filen er lastet opp.',
'fileerror'               => "Det oppstod en feil ved opplasting av filen. Kanskje tillatelsene pÃ¥ <i> vedlegg / </ i> katalogen er feil.\n",
...
'realandemail'            => "Du fylte ikke inn bÃ¥de virkelig navn og e-postadresse feltene.\n",
...
'projectcreated'          => "Din nye prosjektet er opprettet. Du kan nÃ¥ tilpasse prosjektet i prosjektledelse omrÃ¥det.\n",
'customiseproject'        => 'Tilpass dette prosjektet',
'projectupdated'          => 'Preferanser prosjekt oppdatert',
'emptytitle'              => 'Du forlot Prosjekttittel-feltet stÃ¥ tomt. GÃ¥ tilbake og rette den.',
'loginbelow'              => 'Du kan nå prøve å logge inn!',
'attachmentdeletedmsg'    => 'Vedlegget er slettet',
'reminderaddedmsg'        => 'Din pÃ¥minnelse er lagt til.',
'reminderdeletedmsg'      => 'Den valgte pÃ¥minnelse har blitt slettet.',
...
'cancel'                  => 'Avbryt',
'alreadyedited'           => "Denne oppgaven ble redigert av noen andre fÃ¸r du lagret. Har du fortsatt Ã¸nsker Ã¥ lagre endringene?\n",
'saveanyway'              => 'Lagre endringene mine uansett',
'nouserselected'          => "Ingen bruker valgt. Velg minst en bruker fÃ¸r du prÃ¸ver igjen.\n",
'groupswitchupdated'      => 'Brukergrupper endret vellykket.',
'takenownershipmsg'       => 'Denne oppgaven er nÃ¥ tildelt deg.',
...
'dependaddfailed'         => "Det oppsto en feil nÃ¥r du legger til avhengighet. Kontroller at oppgaven finnes, og det er ingen gjensidig blokken.\n",
'depremovedmsg'           => 'Oppgaveavhengighet er fjernet',
'newdepis'                => 'Den nye avhengighet er',
'magicurlsent'            => "En melding har blitt sendt til din varsling adresse. Den inneholder en link som tar deg til en side for Ã¥ fullfÃ¸re denne oppgaven.\n",
'changefspass'            => 'Endre flyspray passord',
'magicurlmessage'         => "FÃ¸lg linken nedenfor for Ã¥ endre flyspray passord:\n",
'erroronform'             => 'Det var et problem med innsending av skjemaet',
'addressused'             => "Denne adressen har blitt brukt til Ã¥ registrere et flyspray konto. Hvis du ikke var ventet denne meldingen, kan ignorere og slette den. GÃ¥ til fÃ¸lgende URL for Ã¥ fullfÃ¸re registreringen:\n",
'confirmcodeis'           => 'Din bekreftelseskode er:',
'codesent'                => "Din bekreftelseskode har blitt sendt. FÃ¸lg instruksjonene i meldingen.\n",
'codenotsent'             => 'Kan ikke sende koden din, vennligst prÃ¸v igjen senere.',
'taskmadeprivatemsg'      => 'Denne oppgaven er gjort personlig',
'taskmadepublicmsg'       => 'Denne oppgaven har blitt gjort offentlig igjen',
'realandnotify'           => "Du mÃ¥ fylle ut ditt virklige Name-feltet, og enten e-postadresse eller Jabber ID-feltet.\n",
'pmreqdeniedmsg'          => 'ForespÃ¸rsel Prosjektleder nektet',
'massopsuccess'           => 'Mass operasjoner vellykkede - hvor tillatelser tillatt',
'usernotexist'            => 'Dennebrukeren finnes ikke pÃ¥ denne flyspray installasjon',
'commentattachperms'      => "Du kan ikke slette denne kommentaren - ingen tillatelse til Ã¥ slette vedlegg\n",
...
'disclaimer'              => "Du mottar denne meldingen fordi du har bedt om det fra flyspray bugtracking system. Hvis du ikke forvente denne meldingen eller ikke Ã¸nsker Ã¥ motta post i fremtiden, kan du endre varslingsinnstillingene pÃ¥ nettadressen vist ovenfor.\n",
'userwho'                 => 'Brukeren som gjorde dette',
'moreinfo'                => 'Mer informasjon finner du pÃ¥ fÃ¸lgende nettadresse:',
'newtaskopened'           => 'En ny flyspray oppgave er blitt Ã¥pnet. Detaljer er nedenfor.',
'notify.taskclosed'       => 'FÃ¸lgende oppgave er nÃ¥ stengt:',
'notify.taskreopened'     => 'Følgende oppgave har blitt gjenåpnet:',
'newdep'                  => 'FÃ¸lgende oppgave har en ny avhengighet:',
'notify.depremoved'       => 'FÃ¸lgende oppgave har hatt en avhengighet fjernet:',
'olddepwas'               => 'Den gamle avhengighet var',
'notify.commentadded'     => 'FÃ¸lgende oppgave har en ny kommentar til:',
'commentis'               => 'Kommentar tekst er nedenfor.',
'newattachment'           => 'En ny fil er knyttet til fÃ¸lgende oppgave:',
'detailsbelow'            => 'Detaljene er under.',
'notify.relatedadded'     => 'En ny beslektet oppgave er lagt til fÃ¸lgende oppgave:',
...
'requiresaction'          => 'FÃ¸lgende oppgave krever handling av en prosjektleder:',
'requiresactionnotify'    => 'Oppgaven krever handling av en prosjektleder',
'pmdeny'                  => "En prosjektleder har avslÃ¥tt forespÃ¸rselen pÃ¥vente for fÃ¸lgende oppgave:\n",
'pmdenynotify'            => 'En prosjektleder har avslÃ¥tt forespÃ¸rselen',
...
'taskchanged'             => "FÃ¸lgende oppgave er endret. Endringene er listet opp nedenfor. For full informasjon om hva som er endret, kan du gÃ¥ til URL og klikk pÃ¥ fanen History.\n",
...
'feedimgurl'              => 'Feed bilde URL (la stÃ¥ tom for ingen bilde)',
...
'priority1'               => 'Utsatt',
'sendcode'                => 'Send kode!',
'entercode'               => "Skriv inn bekreftelseskoden du mottok pÃ¥ varselmelding. Skriv ogsÃ¥ Ã¸nsket konto passord.\n",
'confirmationcode'        => 'Bekreftelseskode',
'registererror'           => "SÃ¸rg for at du har fylt ut alle obligatoriske felter, og at du har lagt inn riktige opplysninger for Ã¸nsket varslingstype.\n",
'validusername'           => '(bare alfanumeriske tegn og -. _ er tillatt)',
'validemail'              => '(bruk ; for Ã¥ skille flere epost-adresser)',
'emailtakenbulk'          => 'Epostadresse er allerede i bruk',
'emailtaken'              => "Den e-postadressen eller Jabber-ID er allerede tatt. Du mÃ¥ velge en annen.\n",
...
'listfrom'                => 'Liste changelog-oppfÃ¸ringer fra',
'to'                      => 'til',
...
'pastmonth'               => 'Den siste mÃ¥neden',
'pastyear'                => 'Det siste Ã¥ret',
...
'Redirect'                => 'Omdirigere',
'redirectmsg'             => "Hvis nettleseren ikke stÃ¸tter meta omdirigering vennligst klikk %sHERE%s for Ã¥ bli omdirigert\n",
...
'thankyouforbug'          => "Takk for rapportering av problemet. Du kan se oppgaven og observere dens fremgang som helst ved hjelp av fÃ¸lgende URL:\n",
...
'pmrequest'               => 'PM forespÃ¸rsel',
'pmrequestdenied'         => 'PM forespÃ¸rsel avvist',
...
'ssl'                     => 'SSL',
'updatewrong'             => "Du har oppdateringen kontrollfunksjonen er aktivert, men en feil oppstod under forsÃ¸k\nÃ¥ kontakte oppdateringsserveren, enten verten tillater ikke utgÃ¥ende tilkoblinger\neller feilen ble forÃ¥rsaket av et nettverksproblem.\nVennligst besÃ¸k flyspray nettsted for Ã¥ sikre at du kjÃ¸rer den nyeste versjonen.\n",
...
'databasemodfailed'       => "Database modifisering mislyktes. Mulige Ã¥rsaker er tilstrekkelige tillatelser.\n",
'frequency'               => 'Frekvens',
'newuserregistered'       => "En ny bruker har registrert pÃ¥ din flyspray installasjon. Bruker detaljene er som fÃ¸lger:\n\n",
...
'mostwanted'              => 'Mest ettersÃ¸kte oppgaver',
'defaultentry'            => 'Standard oppfÃ¸ring side',
'toplevel'                => 'ToppnivÃ¥ view',
'overview'                => 'Oversikt',
'error#'                  => 'Feil #',
'error1'                  => "Du har ikke tilstrekkelige tillatelser til Ã¥ vise dette vedlegget.\n",
'error3'                  => 'Gjentok handlingen, omdirigere til hovedsiden.',
'error4'                  => 'Du har ikke adminrettigheter.',
'error5'                  => 'At brukeren finnes ikke pÃ¥ denne flyspray installasjon.',
'error6'                  => 'Ugyldig adminområde.',
'error7'                  => 'Feil passord!',
'error71'                 => "Kontoen er lÃ¥st for %d minutter pÃ¥ grunn av for mange mislykkede innloggingsforsÃ¸k!\n",
'error8'                  => 'Du skrev ikke inn brukernavn og passord.',
'error9'                  => 'Oppgaven finnes ikke eller ingen rettigheter til Ã¥ vise denne oppgaven.',
'error10'                 => 'Denne oppgaven finnes ikke.',
'error101'                => 'Du har ingen tillatelse til Ã¥ vise denne oppgaven.',
'error102'                => "Du har ingen tillatelse til Ã¥ vise denne oppgaven, logge inn kan hjelpe.\n",
'error11'                 => 'Ingen tilgang til å endre denne kommentaren',
'error12'                 => "Ingen gyldig magiske nÃ¸kkelen! Er du sikker pÃ¥ at du fikk den frÃ¥ meldingen?\n",
'error13'                 => 'Anonyme brukere har ikkje en profil.',
'error14'                 => 'Du har ikkje tilstrekkelige tillatelser til Ã¥ opprette en ny gruppe.',
'error15'                 => 'Du har ikkje tilstrekkelige tillatelser til Ã¥ Ã¥pne en oppgave.',
'error16'                 => 'Du er ikke en prosjektleder.',
'error17'                 => 'Ugyldig PM omrÃ¥det.',
'error18'                 => 'Ugyldig magi URL.',
'error19'                 => 'Den brukeren finnes ikke pÃ¥ denne flyspray installasjon.',
...
'error24'                 => "Verken dot kjÃ¸rbar eller ein offentlig dot-server er blitt satt.\n",
'error25'                 => 'Veikart bare tilgjengelig for et bestemt prosjekt.',
'error26'                 => 'Uegnet OAuth leverandÃ¸r.',
'error27'                 => 'Kan ikkje logge inn. Gje oss tillatelse til Ã¥ vise e-postadressen din.',
'error28'                 => 'Du har ingen tilgang til dette omrÃ¥det.',
'done'                    => 'gjort',
'rss'                     => 'RSS',
'atom'                    => 'Atom',
...
'ordertip'                => 'RekkefÃ¸lgen disse elementene vil vises i listen',
...
'request2'                => 'En forespÃ¸rsel om Ã¥ re-Ã¥pne oppgaven har blitt gjort.',
...
'minpwsize'               => 'Minimum passord stÃ¸rrelse er 5 tegn',
'passwordtoosmall'        => 'Passordet er for kort.',
'accountwaslocked'        => "Kontoen hadde blitt lÃ¥st pÃ¥ grunn av for mange mislykkede innloggingsforsÃ¸k.\n",
'failedattempts'          => 'Det var %d mislykkede innloggingsforsÃ¸k.',
'groupnotexist'           => 'Valgte gruppen finnes ikke i dette prosjektet.',
'searchindetails'         => 'SÃ¸ke detaljer',
...
'nouserstoadd'            => "Ingen brukere Ã¥ legge til. Vennligst sikre navn, brukernavn og e-post er definert for hver bruker.\n",
...
'selfsupertasknotallowed' => 'Super-Task ID kan ikke vÃ¦re det samme som selv OppgÃ¥ve ID',
...
'taskclosedisabled'       => "Lukk Task er deaktivert som fÃ¸lgende avhengige oppgaver er fortsatt Ã¥pen: -\n",
...
'subtaskalreadyhasparent' => "Sub oppgaven du skrev allerede har en overordnet oppgave, mÃ¥ du fjerne dette fÃ¸r assosiere.\n",
...
'subtaskremovedmsg'       => 'Under oppgave har fulfÃ¸rt fjernet',
...
'efforttrackingnotstarted'=> "Kan ikke begynne Ã¥ spore pÃ¥ en sak som allerede spores\n",
...
'viewestimatedeffort'     => 'Kan sjÃ¥ innsats sporing.',
'viewcurrenteffortdone'   => 'Kan sjÃ¥ nÃ¥vÃ¦rende innsats gjort',
'trackeffort'             => 'Kan spore innsats',
'invalideffort'           => 'Innsatsen er ugyldig. MÃ¥ vÃ¦re et tall',
'showpass'                => 'Vis passord',
'chooseafile'             => 'Velg en fil!',
'incorrectfiletype'       => 'Feil filtype. Tillatt: jpg, jpeg, gif, png.',
'oauthreqpass'            => 'Ingen passord for Ã¥ be. Du registrert gjennom %s',
...
'clicktoedit'             => 'Klikk pÃ¥ hvert felt for Ã¥ raskt redigere',
'confirmedit'             => 'OK',
...
'pageswelcomemsg'         => 'Sider for Ã¥ vise hoved intro melding',
'pagesintromsg'           => 'Sider for Ã¥ vise intro melding',
...
'currenteffortdoneformat' => 'NÃ¥vÃ¦rende innsats gjort visningsformat',
'minute'                  => 'minutt',
'minutes'                 => 'minutter',
...
'hoursingular'            => 'time',
'hourabbrev'              => 't',
'estimatedeffortopen'     => 'Estimert innsats for Ã¥pne oppgaver',
'currenteffortdoneopen'   => 'NÃ¥vÃ¦rende innsats brukt i Ã¥pne oppgaver',
'signinwith'              => 'Logg pÃ¥ med %s',
'canviewroadmap'          => 'Kan se veikart',
'enableavatars'           => 'Aktiver avatarer',
'maxavatarsize'           => 'Maksimal avatarstørrelse i piksler',
'taskhassubtask'          => 'Denne oppgaven har fÃ¸lgende sub-oppgave',
'taskhassubtasks'         => 'Denne oppgaven har fÃ¸lgende deloppgaver',
...
'applyfirstline'          => 'PÃ¥ fÃ¸r fÃ¸rste linje',
'addmorerows'             => 'Legg til flere rader',
'addtasks'                => 'Legg til oppgaver',
'massopsdisabled'         => "Beklager, masseredigering for Ã¸yeblikket deaktivert for flyspray 1.0. Vi planlegger Ã¥ fullfÃ¸re gjennomfÃ¸ringen for en senere utgave av flyspray. Du kan aktivere dem i kildekoden pÃ¥ nytt pÃ¥ egen risiko, men leste kommentarene der fÃ¸r du gjÃ¸r det.\n",
'viewroadmap'             => 'Kan se veikart',
'nosuicide'               => "KjÃ¦re bruker, ikke mitt program ikke tillate deg Ã¥ Ã¸delegge din tilgang til flyspray ved Ã¥ deaktivere din egen konto eller bytter din egen gruppe. Den empatiske bror av HAL9000\n",
'movingtodifferentproject'=> "Flytte en oppgave som enten har en forelder eller deloppgaver til et annet prosjekt er ikke tillatt. Du mÃ¥ bryte forbindelsen mellom dem fÃ¸rst.\n",
'musthavesameproject'     => 'Forelder og deloppgave mÃ¥ tilhÃ¸re samme prosjekt.',
...
'enablehtaccess'          => "Vennligst aktiver .htaccess fil i flyspray root fÃ¸r du slÃ¥r url omskriving pÃ¥\n",
'nomodrewrite'            => "Mod omskriving ser ikke ut til Ã¥ vÃ¦re tilgjengelig pÃ¥ denne serveren, beklager, men jeg kan ikke slÃ¥ url omskriving pÃ¥\n",
'on'                      => 'På',
'off'                     => 'Av',
'defaultorderbydirection' => 'Standard rekkefÃ¸lge av retning',
'ascending'               => 'Stigende',
'descending'              => 'Synkende',
