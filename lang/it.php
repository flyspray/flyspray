...
'setglobally'             => 'Questa opzione &egrave; stata impostata a livello globale.',
...
'severitylist'            => 'Lista delle Gravit&agrave;',
'listnote'                => 'Nota: Disabilitare il box "Mostra" potrebbe alterare alcuni task quando in modalit&agrave; modifica.  La modifica del campo "Nome" cambier&agrave; tutti i task con quel nome.',
'name'                    => 'Nome',
'order'                   => 'Ordinamento',
'back'                    => 'Indietro',
'text'                    => 'Testo',
...
'categoryownertip'        => 'Questa persona ricever&agrave; una notifica quando verr&agrave; aperto un Task in questa Categoria',
'categoryparenttip'       => 'La Categoria padre sotto cui cadr&agrave; questa nuova',
'notsubcategory'          => 'Nessuna - &egrave; una categoria primaria',
...
'lostpwexplain'           => 'Inserisci il nome utente e ti verr&agrave; inviato un link per il cambio della password. Il link sar&agrave; inviato all\'indirizzo di notifica configurato nel tuo profilo.',
'sendlink'                => 'Invia link',
...
'canvote'                 => 'Pu&ograve; votare i Task',
...
'accountdisabled'         => 'Il tuo account &egrave; disabilitato, Contatta un Amministratore.',
'task'                    => 'Task',
...
'complete'                => 'completati',
'closedby'                => 'Chiuso da',
'reasonforclosing'        => 'Il motivo della chiusura &egrave;:',
...
'defaultreminder'         => 'Questo &egrave; un promemoria per controllare il seguente task di Flyspray:',
'message'                 => 'Messaggio',
'closed'                  => 'Chiusi',
'filename'                => 'Nome file:',
'date'                    => 'Data',
...
'history'                 => 'Storico',
'nohistory'               => 'Lo storico non &egrave; disponibile',
'eventdate'               => 'Data',
'user'                    => 'Utente',
'event'                   => 'Evento',
'fieldchanged'            => 'Campo cambiato',
'taskopened'              => 'Task aperto',
'taskreopened'            => 'Il Task &egrave; stato riaperto.',
'taskclosed'              => 'Il Task &egrave; stato chiuso.',
'commentadded'            => 'Il Commento &egrave; stato aggiunto.',
'commentedited'           => 'Commento modificato',
'commentdeleted'          => 'Il commento &egrave; stato cancellato.',
'attachmentadded'         => 'Aggiunto allegato',
'attachmentdeleted'       => 'l\'allegato &egrave; stato rimosso',
...
'reminderadded'           => 'Il tuo promemoria &egrave; stato aggiunto.',
'reminderdeleted'         => 'Il promemoria selezionato &egrave; stato eliminato.',
...
'depremoved'              => 'La dipendenza &egrave; stata eliminata',
'depremovedother'         => 'Questo Task &egrave; stato rimosso dalla lista di dipendenze dei Task:',
...
'taskmadeprivate'         => 'Questo Task &egrave; stato reso privato',
'taskmadepublic'          => 'Questo Task &egrave; stato reso pubblico',
...
'autogenerated'           => 'QUESTO &egrave; UN MESSAGGIO GENERATO AUTOMATICAMENTE, NON RISPONDERE',
'forward'                 => 'Avanti',
'previous'                => 'Precedente',
'next'                    => 'Successivo',
'first'                   => 'Primo',
...
'allseverities'           => 'Qualsiasi Gravit&agrave;',
...
'miscellaneous'           => 'Varie',
'users'                   => 'Utenti',
'taskproperties'          => 'Propriet&agrave; del Task',
'selectsincedate'         => 'Seleziona Modificato dal',
'changedsince'            => 'Modificato dal',
'updatefs'                => 'Per favore aggiorna Flyspray.',
'currentversion'          => 'La tua versione &egrave;',
'latestversion'           => 'la versione piu` recente &egrave;',
...
'logout'                  => 'Logout',
'disabledaccount'         => 'La tua utenza &egrave; stata disabilitata!<br>Disconnessione immediata...',
'poweredby'               => 'Powered by Flyspray',
'sponsoredby'             => 'Flyspray &egrave; sponsorizzato da',
'projects'                => 'Progetti',
...
'newtaskcategory'         => 'Un nuovo task &egrave; stato aperto in questa categoria',
'categoryowner'           => 'Stai ricevendo questo messaggio perch&egrave; sei il gestore della categoria.',
'tasksummary'             => 'Riassunto del Task:',
'newtaskadded'            => 'Il tuo nuovo Task &egrave; stato aggiunto.',
'summaryanddetails'       => 'Devi inserire sia il riassunto che i dettagli.',
'summaryrequired'         => 'Devi ',
'goback'                  => 'Torna indietro.',
'messagefrom'             => 'Questo &egrave; un messaggio del sistema di bug tracking Flyspray a',
...
'nolongerassigned'        => 'Il Task seguente non &egrave; piu` assegnato a te. Ora &egrave; assegnato a',
'hasassigned'             => 'ti ha assegnato il seguente task Flyspray:',
'taskupdated'             => 'Il task &egrave; stato aggiornato.',
...
'youonnotify'             => 'Ricevi questo messaggio perch&egrave; sei sulla lista di notifica.',
'taskclosedmsg'           => 'Il Task &egrave; stato chiuso.',
...
'taskreopenedmsg'         => 'Il Task &egrave; stato riaperto.',
'backtotask'              => 'Torna indietro al Task.',
'commentaddedmsg'         => 'Il Commento &egrave; stato aggiunto.',
...
'notcurrentpass'          => 'Non &egrave; la tua Password attuale!',
'passchanged'             => 'La tua Password &egrave; cambiata.',
'closewindow'             => 'Adesso puoi chiudere la finestra.',
'passnomatch'             => 'Le tue nuove password non coincidono!',
'usernametaken'           => 'Questo Nome Utente &egrave; gi&agrave;Â in uso. Devi sceglierne un altro.',
'usernametakenbulk'       => 'Nome Utente non disponibile',
'newusercreated'          => 'Un nuovo Utente &egrave; stato creato.',
'accountcreated'          => 'I tuo Utente &egrave; stato creato.',
...
'confirmwrong'            => 'Il codice di conferma non &egrave; corretto!',
'formnotcomplete'         => 'Il modulo non &egrave; completo.',
'formnotnumeric'          => 'Il dato inserito non &egrave; numerico!',
'groupnametaken'          => 'Questo nome di Gruppo &egrave; gi&agrave; in uso.',
'newgroupadded'           => 'Aggiunto nuovo Gruppo.',
'optionssaved'            => 'Opzioni Flyspray salvate.',
'hasuploaded'             => 'ha caricato un allegato ad un Task che ti &egrave; assegnato a te:',
'hasattached'             => 'ha caricato un allegato al seguente Task.',
'fileuploaded'            => 'Il file &egrave; stato caricato.',
'fileerror'               => 'C`&egrave; stato un errore nel caricamento del file.  Forse i permessi sulla directory degli allegati sono sbagliati.',
...
'listupdated'             => 'La Lista &egrave; stata modificata.',
'listitemadded'           => 'Nuovo elemento aggiunto alla lista.',
'relatedaddedmsg'         => 'Task collegato aggiunto alla lista.',
'relatederror'            => 'Questo Task &egrave; gia nella lista dei Task correlati.',
'relatedremoved'          => 'Task correlato rimosso dalla lista.',
'notifyadded'             => 'Utente aggiunto alla lista di notifica.',
'notifyerror'             => 'l\'utente &egrave; gia nella lista di notifica di questo Task.',
'notifyremoved'           => 'Utente rimosso dalla lista di notifica.',
'editcommentsaved'        => 'Il commento &egrave; stato modificato.',
'commentdeletedmsg'       => 'Il Commento &egrave; stato eliminato.',
'gotonewtask'             => 'Vai al nuovo Task appena creato',
'projectcreated'          => 'Il tuo nuovo Progetto &egrave; stato creato. Segui il link sotto per definire le liste di Categorie, Versioni e Sistema Operativo',
...
'attachmentdeletedmsg'    => 'l\'Allegato &egrave; stato eliminato',
'reminderaddedmsg'        => 'Il tuo Promemoria &egrave; stato inserito.',
'reminderdeletedmsg'      => 'Il Promemoria selezionato &egrave; stato eliminato.',
'flyspraytask'            => 'Task Flyspray',
'fieldsmissing'           => 'Alcuni campi contenevano dati errati o mancanti.',
'relatedinvalid'          => 'Non c`&egrave; questo Task.',
'relatedproject'          => 'Il Task appartiene ad un Progetto differente.',
'addanyway'               => 'Aggiungi comunque',
'cancel'                  => 'Cancella',
'alreadyedited'           => 'Il Task &egrave; stato modificato da qualcun altro prima che lo salvassi.',
...
'takenownershipmsg'       => 'Questo Task &egrave; ora assegnato a te.',
'adminrequestmade'        => 'La tua richiesta &egrave; stata trasmessa ad un Amministratore del Progetto.',
'newdepnotify'            => 'Una nuova dipendenza &egrave; stata aggiunta al seguente Task:',
'dependadded'             => 'La dipendenza &egrave;stata aggiunta',
'dependaddfailed'         => 'Non puoi aggiungere il Task come dipendenza in questo momento',
'depremovedmsg'           => 'La dipendenza del Task &egrave; stata eliminata',
'newdepis'                => 'La nuova dipendenza &egrave;',
'magicurlsent'            => 'Un messaggio &egrave; stato inviato al tuo indirizzo di notifica. Contiene un link che ti porter&agrave; ad una pagina per completare questo Task.',
'changefspass'            => 'Cambia la Password di Flyspray',
'magicurlmessage'         => 'Segui questo link per cambiare la tua password Flyspray:',
'erroronform'             => 'C`&egrave; stato un problema su questo modulo',
'addressused'             => 'Questo indirizzo &egrave; stato usato per registrare un account Flyspray. Se non stavi aspettando questo messaggio, ti prego di ignorarlo e di cancellarlo. Il tuo codice di conferma &egrave;:',
'confirmcodeis'           => 'Il tuo codice di conferma &egrave;:',
'codesent'                => 'Il tuo codice di conferma &egrave; stato inviato. Prego segui le istruzioni contenute nel messaggio.',
'codenotsent'             => 'Non posso inviarti il codice, per favore riprova piu` tardi',
'taskmadeprivatemsg'      => 'Questo Task &egrave; stato reso privato',
'taskmadepublicmsg'       => 'Questo Task &egrave; stato reso pubblico',
...
'voterecorded'            => 'Il tuo Voto &egrave; stato registrato',
'votefailed'              => 'Il tuo Voto non pu&ograve; essere inserito in questo momento.',
...
'htmlallowed'             => '&egrave; possibile inserire codice HTML',
...
'donotreply'              => 'QUESTO &egrave; UN MESSAGGIO AUTOMATICO, NON RISPONDERE.',
'disclaimer'              => 'Hai ricevuto questo messaggio perch&egrave; lo hai richiesto al sistema di bugtracking Flyspray. Puoi disabilitare le notifiche future visitando l\'indirizzo qui sopra.',
'userwho'                 => 'Utente che ha effettuato l\'operazione',
'moreinfo'                => 'Maggiori informazioni disponibili all\'indirizzo:',
'newtaskopened'           => 'Un nuovo Task &egrave; stato aperto su Flyspray. Maggiori dettagli di seguito.',
'notify.taskclosed'       => 'Il Task seguente &egrave; stato chiuso:',
'notify.taskreopened'     => 'Il Task seguente &egrave; stato riaperto:',
'newdep'                  => 'Il Task seguente ha una nuova dipendenza:',
'notify.depremoved'       => 'Al Task seguente &egrave; stata rimossa una dipendenza:',
'olddepwas'               => 'La vecchia dipendenza era',
'notify.commentadded'     => 'Al Task seguente &egrave; stato aggiunto un commento:',
'commentis'               => 'Il commento &egrave; indicato di seguito.',
'newattachment'           => 'Un nuovo file &egrave; stato allegato al seguente Task:',
'detailsbelow'            => 'Di seguito i dettagli.',
'notify.relatedadded'     => 'Un nuovo Task collegato &egrave; stato aggiunto al seguente Task:',
'relatedis'               => 'Il Task collegato &egrave;',
'assignedtoyou'           => 'Ti &egrave; stato assegnato il seguente Task:',
'takenownership'          => 'Questo task non &egrave; assegnato a te.',
...
'fileaddedtoo'            => 'C`erano gi&agrave; uno o piu` file allegati a questo commento.',
'taskwatching'            => 'Il seguente Task che stai controllando',
'isdepfor'                => '&egrave; una nuova dipendenza per',
'denialreason'            => 'Motivo del rifiuto',
'taskchanged'             => 'Il seguente Task &egrave; stato modificato. Le modifiche sono elencate qui` sotto. Per informazioni piu` dettagliate sulle modifiche visita l\'indirizzo seguente e clicca sullo Storico.',
'useraddedtoassignees'    => 'Un Utente ha aggiunto s&egrave; stesso alla lista degli utenti assegnati a questo Task.',
'removeddepis'            => 'La dipendenza rimossa &egrave;',
'isnodepfor'              => 'non &egrave; piu` una dipendenza per',
...
'entercode'               => 'Il tuo codice di conferma &egrave; stato inviato usando il tuo metodo di notifica preferenziale. Quando lo ricevi, inseriscilo qui sotto.  Inserisci anche la Password dell\'Account.',
...
'emailtakenbulk'          => 'Indirizzo email gi&agrave; utilizzato',
'emailtaken'              => 'l\'indirizzo Email o lo Jabber-ID sono gi&agrave; in uso. Devi selezionarne un altro.',
...
'severityrep'             => 'Rapporto per Gravit&agrave;',
'totalopen'               => 'totale Task aperti',
'age'                     => 'Et&agrave;',
'agerep'                  => 'Rapporto per et&agrave;',
...
'frequency'               => 'Frequenza',
'newuserregistered'       => 'Un nuovo Utente si &egrave; registrato. Di seguito i dettagli:',
'newuserregisterednotify' => 'Un nuovo Utente si &egrave; registrato',
...
'alreadyvotedthistask'    => 'hai gi&agrave; votato per questo Task',
'alreadyvotedthisday'     => 'hai gi&agrave; votato oggi',
...
'novalidemail'            => 'l\'indirizzo Email inserito non &egrave; valido.',
'novalidjabber'           => 'l\'ID Jabber inserito non &egrave; valido.',
...
'error22'                 => 'Non &egrave; possibile registrare nuovi Utenti.',
'error23'                 => 'Utente o Gruppo non abilitato.',
'error24'                 => 'Un eseguibile di Dot o un server pubblico Dot non sono stati configurati.',
'error25'                 => 'La Roadmap &egrave; disponibile solo per un Progetto specifico.',
...
'rss'                     => 'RSS',
'atom'                    => 'Atom',
'projectnotdeleted'       => 'Il Progetto non pu&ograve; essere eliminato.',
'GMT'                     => 'GMT',
...
'lastuser'                => 'l\'ultimo Utente non pu&ograve; essere eliminato.',
...
'del'                     => 'cancella',
'request1'                => '&egrave; stata richiesta la chiusura di un task',
'request2'                => '&egrave; stata richiesta la riapertura del task',
'allpriorities'           => 'Tutte le Priorit&agrave;',
...
'minpwsize'               => 'La lunghezza minima della password &egrave; di 5 caratteri',
'passwordtoosmall'        => 'La password &egrave; troppo corta.',
'accountwaslocked'        => 'Il tuo account &egrave; stato bloccato a causa di troppi tentativi di login falliti.',
...
'find'                    => 'Trova',
'tls'                     => 'TLS',
'isadmin'                 => '&egrave; admin',
'addvotes'                => 'Aggiungi Voti',
'removevote'              => 'Rimuovi Voto',
'voteremoved'             => 'Il tuo voto &egrave; stato rimosso',
'voteremovefailed'        => 'Il voto non pu&ograve; essere rimosso in questo momento.',
...
'supertaskmodified'       => 'ID Super-Task &egrave; stato modificato',
'set'                     => 'Imposta',
'supertask'               => 'Super-Task',
'setparent'               => 'Imposta id del task genitore per questo task',
'selfsupertasknotallowed' => 'L\'ID del super-task non pu&ograve; essere uguale all\'ID dell\'attuale Task',
...
'taskclosedisabled'       => 'La Chiusura Task &egrave; attualmente disabilitata in quanto i seguenti task dipendenti sono ancora aperti:-',
'daysleft'                => 'Giorni mancanti',
'dayoverdue'              => 'Giorni di Ritardo',
'duetoday'                => 'Da fare oggo.',
...
'subtaskalreadyhasparent' => 'Il sotto task inserito ha gi&agrave; un task genitore. Si prega di correggere prima di associare.',
'subtaskisparent'         => 'Il sotto-task inserito &egrave; il task genitore di questo task. Sotto-task non associato.',
'subtasknotexist'         => 'Il sotto task inserito non esiste.',
'subtaskremovedmsg'       => 'Il sotto task &egrave; stato rimosso con successo',
...
'invalidsupertaskid'      => 'L\'id del Task genitore non &egrave; valido',
...
'efforttrackingnotstarted'=> 'Impossibile iniziare a monitorare su di un problema gi&agrave; in monitoraggio.',
...
'viewestimatedeffort'     => 'Pu&ograve; visualizzare il monitoraggio dell\'Impegno',
'viewcurrenteffortdone'   => 'Pu&ograve; visualizzare l\'attuale Impegno impiegato',
'trackeffort'             => 'Pu&ograve; monitorare l\'Impegno',
'invalideffort'           => 'L\'Impegno inserito non &egrave; valido. Devono essere solo numeri',
...
'clicktoedit'             => 'Clicca su goni campo per modificarlo velocemente',
...
'myactivity'              => 'Le mie attivit&agrave;',
...
'itemexists'              => 'L\'elemento %s gi&agrave; esiste nel database.',
'categoryitemexists'      => 'L\'elemento %s gi&agrave; esiste nella categoria %s nel database.',
...
'canviewroadmap'          => 'Pu&ograve; vedere la roadmap',
...
'movingtodifferentproject'=> 'Non &egrave; permesso spostare task che hanno un task padre o sotto-task in un altro progetto. E\' necessario slegarli dai relativi task nel progetto originario.',
...
'tag'                     => 'Tag',
'tags'                    => 'Tag',
'tagsinfo'                => 'Libera possibilit&agrave; di Tag dei task. Separa i tab con ;. Non vengono utilizzati per ricerca, ordinamento o filtro.',
'novalues'                => 'Nessun elemento',
'youhaveregistered'       => "Ti seri registrato.\nLe tue informazioni sono le seguenti:",
'youhaveregisterednotify' => 'La tua registrazione &egrave; stata accettata dagli amministratori.',
