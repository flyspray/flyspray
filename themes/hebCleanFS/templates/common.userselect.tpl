...
<script type="text/javascript">
    ...
    new Ajax.Autocompleter('<?php echo Filters::noJsXSS($id); ?>', '<?php echo Filters::noJsXSS($name); ?>_complete', '<?php echo Filters::noXSS($baseurl); ?>javascript/callbacks/usersearch.php', {})
</script>
