...
<?php endf; ?>
	...
	<tr>
		...
		?></td>
		<td><?php
		if($user->id == $details['user_id'] && is_null($details['end_timestamp'])): ?>
			<input type="text" name="stop_description" id="stop_description" size="10" placeholder="optional" title="optional description"/>
