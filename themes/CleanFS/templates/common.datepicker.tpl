...
*/
?>
<input id="<?php echo Filters::noXSS($name); ?>" type="date" placeholder="YYYY-MM-DD" maxlength="10" name="<?php echo Filters::noXSS($name); ?>" value="<?php echo Filters::noXSS($date); ?>" />
<!-- <a class="datelink" href="#" id="<?php echo Filters::noXSS($name); ?>dateview"></a> -->
