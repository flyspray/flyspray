<div id="related" class="tab">
  ...
  <form class="clear" action="{CreateUrl('details', $task_details['task_id'])}#related" method="post" id="formaddrelatedtask">
    <div>
      ...
      <button type="submit" onclick="return checkok('{#$baseurl}js/callbacks/checkrelated.php?related_task=' + $('related_task_input').value + '&amp;project={$proj->id}', '{#L('relatedproject')}', 'formaddrelatedtask')">{L('add')}</button>
    </div>
  </form>
  <?php endif; ?>
</div>
