...
<div id="login_input">
	<input placeholder="<?php echo Filters::noXSS(L('username')); ?>" class="text fi-medium" type="text" id="lbl_user_name" name="user_name" size="17" maxlength="32" />
	<input placeholder="<?php echo Filters::noXSS(L('password')); ?>" class="password fi-medium" type="password" id="lbl_password" name="password" size="17" maxlength="100" />
	<div>
