<div class="box">
	...
	<p><strong><?php echo Filters::noXSS(L('pruninglevel')); ?>: </strong><?php echo implode(" &nbsp;|&nbsp; \n", $strlist); ?></p>

<div id="infovis" style="width:90%;height:50em; margin: 0 auto;border: 1px solid #e1e1e1;"></div>
