...
<div id="actionbar">
	<button class="button positive" type="submit" accesskey="s" onclick="return checkok('{#$baseurl}js/callbacks/checksave.php?time={time()}&amp;taskid={$task_details['task_id']}', '{#L('alreadyedited')}', 'taskeditform')">{L('savedetails')}</button>
	<div class="clear"></div>
</div>
    ...
    <div id="taskfields">
      <ul class="form_elements slim">
		...
		<div id="taskdetailsfull">
          ...
          <?php endif; ?>
		  <p class="buttons">
              <!--<button type="submit" accesskey="s" onclick="return checkok('{#$baseurl}js/callbacks/checksave.php?time={time()}&amp;taskid={$task_details['task_id']}', '{#L('alreadyedited')}', 'taskeditform')">{L('savedetails')}</button>-->
              <?php if (defined('FLYSPRAY_HAS_PREVIEW')): ?>
