...
<div id="toolboxmenu">
	<a id="projprefslink" <?php if(isset($_GET['area']) and $_GET['area'] == 'prefs') echo $activeclass;
	...
	<a id="projuglink" <?php if(isset($_GET['area']) and ($_GET['area'] == 'groups' || $_GET['area'] == 'newgroup' || $_GET['area'] == 'editgroup') ) echo $activeclass;
	...
	<a id="projcatlink" <?php if(isset($_GET['area']) and $_GET['area'] == 'cat') echo $activeclass;
	...
	<a id="projttlink" <?php if(isset($_GET['area']) and $_GET['area'] == 'tasktype') echo $activeclass;
	...
	<a id="projtglink" <?php if(isset($_GET['area']) and $_GET['area'] == 'tag') echo $activeclass;
	...
	<a id="projstatuslink" <?php if(isset($_GET['area']) and $_GET['area'] == 'status') echo $activeclass;
	...
	<a id="projreslink" <?php if(isset($_GET['area']) and $_GET['area'] == 'resolution') echo $activeclass;
	...
	<a id="projverlink" <?php if(isset($_GET['area']) and $_GET['area'] == 'version') echo $activeclass;
	...
	<a id="projoslink" <?php if(isset($_GET['area']) and $_GET['area'] == 'os') echo $activeclass;
	...
	<a id="projreqlink" <?php if(isset($_GET['area']) and $_GET['area'] == 'pendingreq') echo $activeclass;
