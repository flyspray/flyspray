...
<div id="toolboxmenu">
	<a id="globprefslink"<?php
		if(isset($_GET['area']) and $_GET['area'] == 'prefs') echo $activeclass;
	...
	<a id="globuglink"<?php if(isset($_GET['area']) and in_array($_GET['area'], array('groups','newuser', 'newuserbulk', 'newgroup','editgroup', 'users', 'editallusers'))) echo $activeclass;
	...
	<a id="globttlink"<?php if(isset($_GET['area']) and $_GET['area'] == 'tasktype') echo $activeclass;
	...
	<a id="globcatlink"<?php if(isset($_GET['area']) and $_GET['area'] == 'cat') echo $activeclass;
	...
	<a id="globtglink"<?php if(isset($_GET['area']) and $_GET['area'] == 'tag') echo $activeclass;
		?> href="<?php echo Filters::noXSS(CreateURL('admin', 'tag')); ?>"><span class="fas fa-tag"></span><span><?php echo Filters::noXSS(L('tags') ); ?></span></a>
	<a id="globstatuslink"<?php if(isset($_GET['area']) and $_GET['area'] == 'status') echo $activeclass;
	...
	<a id="globreslink"<?php if(isset($_GET['area']) and $_GET['area'] == 'resolution') echo $activeclass;
	...
	<a id="globverlink"<?php if(isset($_GET['area']) and $_GET['area'] == 'version') echo $activeclass;
	...
	<a id="globoslink"<?php if(isset($_GET['area']) and $_GET['area'] == 'os') echo $activeclass;
	...
	<a id="globnewprojlink"<?php if(isset($_GET['area']) and $_GET['area'] == 'newproject') echo $activeclass;
	...
	<a id="userrequestlink"<?php if(isset($_GET['area']) and $_GET['area'] == 'userrequest') echo $activeclass;
	...
	<a id="translationslink"<?php if(isset($_GET['area']) and $_GET['area'] == 'translations') echo $activeclass;
	...
	<a id="checkslink"<?php if(isset($_GET['area']) and $_GET['area'] == 'checks') echo $activeclass;
