...
<tr id="task<?php echo $task['task_id']; ?>" class="severity<?php echo $task['task_severity'];  $task['is_closed'] ==1 ? ' closed': '';?>" onmouseover="Show(this,<?php echo $task['task_id']; ?>)" onmouseout="Hide(this, <?php echo $task['task_id']; ?>)">
	<td class="caret"></td>
