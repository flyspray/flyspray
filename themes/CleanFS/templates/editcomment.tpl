			...
			<div class="commenttext">
				...
				<div id="attachmentsbox">
					...
					<div id="uploadfilebox">
						...
						<span class="newitem" style="display: none;"><!-- this span is shown/copied in javascript when adding files -->
							<input tabindex="5" class="file" type="file" size="55" name="userfile[]" />
							<a href="javascript://" tabindex="6" class="button" title="<?php echo Filters::noXSS(L('remove')); ?>" onclick="removeUploadField(this);"><span class="fas fa-xmark fa-lg"></span></a>
						</span>
						<noscript>
							<input tabindex="5" class="file" type="file" size="55" name="userfile[]" />
						</noscript>
