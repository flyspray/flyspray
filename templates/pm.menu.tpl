<div id="toolboxmenu">
  ...
  <a id="projttlink"    href="{CreateURL('pm', 'tt',         $proj->id)}">{L('tasktypes')}</a>
  <a id="projstatuslink" href="{CreateURL('pm', 'status',     $proj->id)}">{L('taskstatuses')}</a>
  <a id="projreslink"   href="{CreateURL('pm', 'res',        $proj->id)}">{L('resolutions')}</a>
  ...
  <a id="projverlink"   href="{CreateURL('pm', 'ver',        $proj->id)}">{L('versions')}</a>
